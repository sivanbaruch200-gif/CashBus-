    ...
    <div className="min-h-screen bg-surface-overlay py-8 px-4" dir="rtl">
      <div className="max-w-4xl mx-auto bg-surface-raised rounded-lg shadow-lg p-8">
        ...
        <section className="mb-8">
          ...
          <div className="text-content-secondary space-y-3">
            ...
            <p>
              ...
              לרבות הפרטים האישיים, תיאור האירועים, והסכומים הנדרשים.
            </p>
            <p>
        ...
        <section className="mb-8">
          ...
          <div className="text-content-secondary space-y-3">
            ...
            <p>
              ...
              לחיצה על כפתור האישור, המהווה חתימה אלקטרונית בהתאם לחוק חתימה אלקטרונית.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8 bg-status-pending-surface p-6 rounded-lg border border-status-pending/20">
          ...
          <div className="text-content-secondary space-y-3">
            <p>
              8.1 משתמשים מתחת לגיל 18 <strong>חייבים לקבל הסכמת הורה או אפוטרופוס</strong>
              לפני השימוש בשירות.
            </p>
            <p>
              8.2 הורה או אפוטרופוס של קטין המאשר את ההרשמה <strong>נושא באחריות מלאה</strong>
              לפעולות הקטין במערכת, כולל חובת דיווח על פיצויים ותשלום עמלת הצלחה.
            </p>
            <p>
              8.3 CashBus שומרת לעצמה את הזכות לבקש אימות גיל והסכמת הורים בכל שלב.
            </p>
          </div>
        </section>
        ...
        {/* איחוד תביעות */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-accent mb-4">9. טיפול בדיווחים</h2>
          <div className="text-content-secondary space-y-3">
            <p>
              9.1 <strong>כל דיווח = מכתב דרישה נפרד.</strong> כל אירוע שמדווח במערכת
              מטופל בנפרד ונשלח כמכתב דרישה עצמאי לחברת התחבורה.
            </p>
            <p>
              9.2 <strong>עמלת הצלחה לכל פיצוי:</strong> עמלת ההצלחה (20%) תחושב מכל
              פיצוי שהתקבל בנפרד.
            </p>
            <p>
              9.3 המערכת שומרת על פשטות - <strong>אירוע אחד = תביעה אחת</strong>.
            </p>
          </div>
        </section>
        ...
        {/* ביטול והפסקת שימוש */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-accent mb-4">10. ביטול והפסקת שימוש</h2>
          <div className="text-content-secondary space-y-3">
            <p>
              10.1 המשתמש רשאי להפסיק את השימוש בשירות בכל עת.
            </p>
            <p>
              10.2 <strong>חשוב:</strong> הפסקת השימוש אינה פוטרת מחובת תשלום עמלת הצלחה
              על פיצויים שהתקבלו בעקבות פניות שנעשו באמצעות המערכת, גם לאחר הביטול.
            </p>
            <p>
              10.3 CashBus שומרת לעצמה את הזכות לחסום או להשעות משתמש שמפר את תנאי השימוש.
            </p>
          </div>
        </section>
        ...
        {/* שינויים בתנאים */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-accent mb-4">11. שינויים בתנאי השימוש</h2>
          <div className="text-content-secondary space-y-3">
            <p>
              11.1 CashBus שומרת לעצמה את הזכות לעדכן תנאים אלה מעת לעת.
            </p>
            <p>
              11.2 שינויים מהותיים יפורסמו באתר ו/או יישלחו למשתמשים בדוא&quot;ל.
            </p>
            <p>
              11.3 המשך השימוש בשירות לאחר פרסום שינויים מהווה הסכמה לתנאים המעודכנים.
            </p>
          </div>
        </section>
        ...
        {/* דין וסמכות שיפוט */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-accent mb-4">12. דין וסמכות שיפוט</h2>
          <div className="text-content-secondary space-y-3">
            <p>
              12.1 תנאי שימוש אלה כפופים <strong>לחוקי מדינת ישראל</strong> בלבד.
            </p>
            <p>
              12.2 סמכות השיפוט הבלעדית בכל סכסוך הנובע מתנאים אלה נתונה
        ...
        {/* יצירת קשר */}
        <section className="mb-8 bg-accent-surface p-6 rounded-lg border border-accent-border">
          <h2 className="text-xl font-semibold text-accent mb-4">13. יצירת קשר</h2>
          <div className="text-content-secondary space-y-3">
            <p>
